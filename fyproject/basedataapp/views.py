...
class ActivityNatureDetailView(CreatedFieldsMixin, generics.RetrieveUpdateDestroyAPIView):
    queryset = ActivityNature.objects.all()
    serializer_class = ActivityNatureSerializer
    lookup_field = 'code'
...
class StructureTypeDetailView(CreatedFieldsMixin, generics.RetrieveUpdateDestroyAPIView):
    queryset = StructureType.objects.all()
    serializer_class = StructureTypeSerializer
    lookup_field = 'code'
